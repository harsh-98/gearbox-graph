...
export function handleAddressSet(event: AddressSet): void {
  ...
  // - contract.ACL(...)
  // - contract.CONTRACTS_REGISTER(...)
  // - contract.DATA_COMPRESSOR(...)
  // - contract.GEAR_TOKEN(...)
  // - contract.LEVERAGED_ACTIONS(...)
  // - contract.PRICE_ORACLE(...)
  // - contract.TREASURY_CONTRACT(...)
  // - contract.WETH_GATEWAY(...)
  // - contract.WETH_TOKEN(...)
  // - contract.addresses(...)
  // - contract.getACL(...)
  // - contract.getAccountFactory(...)
  // - contract.getContractsRegister(...)
